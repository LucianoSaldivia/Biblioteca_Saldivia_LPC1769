...
void UART3_Init ( void ){
    ...
    U3LCR &= ~( 0x01 << 3 );		// Bit 3. Parity enable. 0 es desactivada
	...
	*/
    ...
    U3FDR = 0;
    U3FDR |= ( 0x0E << 4 );     // Bits 4:7 . MULVAL = 14
    U3FDR |= 0x05;              // Bits 0:3 . DIVADDVAL = 5
    ...
    //6.- Registro U3LCR, pongo DLAB(bit7) en 0
    U3LCR &= ~( 0x01 << 7 );

    //7. Habilito las interrupciones de RX y TX en la UART3 (Registro U3IER)
    U3IER = 0x03;

    //8. Habilito la interrupción de la UART3 en el NVIC (Registro ISER0)
    ISER0 |= ( 0x01 << 8 );
}

void UART3_Inicializar( uint8_t PCLK, uint8_t BaudRate, uint8_t Data_Bits, uint8_t Parity, uint8_t Stop_Bits ){
    //1.- Registro PCONP - bit 3 en 1 habilita la UART3
    PCONP |= ( 0x01 << 25 );

    //2.- Registro PCLKSEL0 - bits 6 y 7 seleccionan el PCLK de la UART3
    PCLKSEL0 &= ~( 0x03 << 18 ); // Bits 6 y 7 en 0, para "reiniciar" el registro
    switch( PCLK ){
    ...
    U3LCR &= ~( 0x01 << 6 );	// Bit 6. Break Control. <0> es disabled (por default)
                                                      // <1> es enabled
    ...
    */
        ...
        */
            switch( PCLK ){
                case PCLK_CCLK_1:
                    ...
                    U3FDR = 0;                  // Pongo en 0 para después hacer U3FDR |=
                    U3FDR |= ( 0x00 << 0 );     // DivAddVal = 0
                    U3FDR |= ( 0x01 << 4 );     // MulVal = 1
                    break;
                ...
                case PCLK_CCLK_8:
                    ...
                    U3FDR = 0;                  // Pongo en 0 para después hacer U3FDR |=
                    U3FDR |= ( 0x01 << 0 );     // DivAddVal = 1
                    U3FDR |= ( 0x04 << 4 );     // MulVal = 4
                    break;
        ...
        */
            ...
            switch( PCLK ){
                ...
                case PCLK_CCLK_8:
                    ...
                    U3FDR = 0;                  // Pongo en 0 para después hacer U3FDR |=
                    U3FDR |= ( 0x02 << 0 );     // DivAddVal = 2
                    U3FDR |= ( 0x05 << 4 );     // MulVal = 5
                    break;
        ...
        */
            ...
            switch( PCLK ){
                ...
                case PCLK_CCLK_8:
                    ...
                    U3FDR = 0;                  // Pongo en 0 para después hacer U3FDR |=
                    U3FDR |= ( 0x00 << 0 );     // DivAddVal = 1
                    U3FDR |= ( 0x0B << 4 );     // MulVal = 11
                    break;
        ...
        */
            ...
            switch( PCLK ){
                ...
                case PCLK_CCLK_8:
                    ...
                    U3FDR = 0;                  // Pongo en 0 para después hacer U3FDR |=
                    U3FDR |= ( 0x03 << 0 );     // DivAddVal = 3
                    U3FDR |= ( 0x08 << 4 );     // MulVal = 8
                    break;
        ...
        */
            ...
            switch( PCLK ){
                ...
                case PCLK_CCLK_8:
                    ...
                    U3FDR = 0;                  // Pongo en 0 para después hacer U3FDR |=
                    U3FDR |= ( 0x05 << 0 );     // DivAddVal = 5
                    U3FDR |= ( 0x0D << 4 );     // MulVal = 13
                    break;
        ...
        */
            ...
            switch( PCLK ){
                case PCLK_CCLK_1:
                    ...
                    U3FDR = 0;                  // Pongo en 0 para después hacer U3FDR |=
                    U3FDR |= ( 0x07 << 0 );     // DivAddVal = 7
                    U3FDR |= ( 0x0C << 4 );     // MulVal = 12
                    break;
    ...
    //7. Habilito las interrupciones de RX y TX en la UART3 (Registro U3IER)
    U3IER = ( 0x00 << 0 );   // Sin Interrupciones
    U3IER |= ( 0x01 << 0 );  // Habilito interrupciones RX
    U3IER |= ( 0x02 << 0 );  // Habilito interrupciones TX
...
void UART3_StartTx( void ){
    if( U3_Index_In_Tx != U3_Index_Out_Tx ){
        U3_REGISTRO_TX = dato;	// Fuerzo la transmisión del primer dato
    }
}
